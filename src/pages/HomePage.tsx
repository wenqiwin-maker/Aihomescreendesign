...
export function HomePage() {
  ...
  return (
    <div className="relative w-[390px] h-screen mx-auto overflow-y-auto bg-white no-scrollbar">
      {/* Top Section */}
      <div className="relative w-[390px] h-[321px]">
      ...
      {/* Body Section */}
      <div
        className="relative w-[390px] left-0 bg-white rounded-t-[20px] flex flex-col gap-[30px] p-5"
        style={{ marginTop: '-46px', paddingBottom: '120px' }}
      >
