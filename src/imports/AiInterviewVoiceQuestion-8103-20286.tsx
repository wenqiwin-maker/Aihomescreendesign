...
function ImageAiCharacter() {
  return (
    <div className="absolute h-[477px] left-0 overflow-clip top-[-17px] w-[390px]" data-name="Image (AI Character)">
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[27px] top-[377px]">
      <div className="relative shrink-0 size-[6px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
          <circle cx="3" cy="3" fill="var(--fill-0, black)" id="Ellipse 319" r="3" />
        </svg>
      </div>
      <p className="font-['SF_Pro:Medium',sans-serif] font-[510] leading-[20px] relative shrink-0 text-[16px] text-neutral-950 tracking-[-0.1504px] w-[325px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Evidence-Why
      </p>
    </div>
  );
...
function Frame2() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[27px] top-[548px]">
      <div className="relative shrink-0 size-[6px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
          <circle cx="3" cy="3" fill="var(--fill-0, black)" id="Ellipse 319" r="3" />
        </svg>
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[27px] top-[772px]">
      <div className="relative shrink-0 size-[6px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
          <circle cx="3" cy="3" fill="var(--fill-0, black)" id="Ellipse 319" r="3" />
        </svg>
...
function Frame() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[27px] top-[70px]">
      <div className="relative shrink-0 size-[6px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6 6">
          <circle cx="3" cy="3" fill="var(--fill-0, black)" id="Ellipse 319" r="3" />
        </svg>
...
function ChatBubbleUser() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[8px] items-center justify-center left-0 px-[12px] py-[8px] rounded-bl-[18px] rounded-br-[18px] rounded-tr-[18px] top-0" data-name="chat-bubble-user">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 text-nowrap text-right tracking-[-0.1504px] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function ChatBubbleAi() {
  return (
    <div className="absolute bg-[rgba(140,0,255,0.1)] box-border content-stretch flex flex-col gap-[8px] items-center justify-center left-[210px] px-[12px] py-[8px] rounded-bl-[18px] rounded-tl-[18px] rounded-tr-[18px] top-[44px]" data-name="chat-bubble-AI">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 text-nowrap text-right tracking-[-0.1504px] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Ok, Let’s start
      </p>
    </div>
...
function ChatBubbleUser1() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[8px] items-center justify-center left-0 px-[12px] py-[8px] rounded-bl-[18px] rounded-br-[18px] rounded-tr-[18px] top-[88px]" data-name="chat-bubble-user">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 text-nowrap text-right tracking-[-0.1504px] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function ChatBubbleAi1() {
  return (
    <div className="absolute bg-[rgba(140,0,255,0.1)] box-border content-stretch flex flex-col gap-[8px] items-end justify-center left-[23px] px-[12px] py-[8px] rounded-bl-[18px] rounded-tl-[18px] rounded-tr-[18px] top-[132px] w-[302px]" data-name="chat-bubble-AI">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 text-right tracking-[-0.1504px] w-[278px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function ChatBubbleUser2() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[8px] items-center justify-center left-0 px-[12px] py-[8px] rounded-bl-[18px] rounded-br-[18px] rounded-tr-[18px] top-[196px] w-[302px]" data-name="chat-bubble-user">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 tracking-[-0.1504px] w-[278px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function ChatBubbleAi2() {
  return (
    <div className="absolute bg-[rgba(62,95,255,0.1)] box-border content-stretch flex flex-col gap-[8px] items-end justify-center left-[23px] px-[12px] py-[8px] rounded-bl-[18px] rounded-tl-[18px] rounded-tr-[18px] top-[307px] w-[302px]" data-name="chat-bubble-AI">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 text-right tracking-[-0.1504px] w-[278px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function ChatBubbleUser3() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[8px] items-center justify-center left-0 px-[12px] py-[8px] rounded-bl-[18px] rounded-br-[18px] rounded-tr-[18px] top-[371px] w-[302px]" data-name="chat-bubble-user">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 tracking-[-0.1504px] w-[278px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        At Evidence section, you need to provide some strong impact
      </p>
    </div>
...
function ChatBubbleAi3() {
  return (
    <div className="absolute bg-[rgba(62,95,255,0.1)] box-border content-stretch flex flex-col gap-[8px] items-end justify-center left-[23px] px-[12px] py-[8px] rounded-bl-[18px] rounded-tl-[18px] rounded-tr-[18px] top-[479px] w-[302px]" data-name="chat-bubble-AI">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 text-right tracking-[-0.1504px] w-[278px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function ChatBubbleAi4() {
  return (
    <div className="absolute bg-[rgba(62,95,255,0.1)] box-border content-stretch flex flex-col gap-[8px] items-end justify-center left-[23px] px-[12px] py-[8px] rounded-bl-[18px] rounded-tl-[18px] rounded-tr-[18px] top-[627px] w-[302px]" data-name="chat-bubble-AI">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 text-right tracking-[-0.1504px] w-[278px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        Thank you very much
      </p>
    </div>
...
function ChatBubbleUser4() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[8px] items-center justify-center left-0 px-[12px] py-[8px] rounded-bl-[18px] rounded-br-[18px] rounded-tr-[18px] top-[563px] w-[302px]" data-name="chat-bubble-user">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-950 tracking-[-0.1504px] w-[278px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function ChatBubble() {
  return (
    <div className="absolute h-[616px] left-[45px] top-[106px] w-[325px]" data-name="ChatBubble">
      <ChatBubbleUser />
      <ChatBubbleAi />
      <ChatBubbleUser1 />
      <ChatBubbleAi1 />
...
function ChatBubblePopUp() {
  return (
    <div className="absolute contents left-0 top-[-1px]" data-name="chat-bubble pop up">
      <div className="absolute bg-gradient-to-b from-[#f3f4f6] from-[0.592%] h-[790px] left-0 rounded-tl-[24px] rounded-tr-[24px] to-[#eceef1] top-[-1px] w-[390px]" />
      <div className="absolute flex h-[283px] items-center justify-center left-[29px] top-[93px] w-0" style={{ "--transform-inner-width": "283", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg]">
          <div className="h-0 relative w-[283px]">
            <div className="absolute bottom-[-7.36px] left-0 right-[-0.35%] top-[-7.36px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 284 15">
                <path d={svgPaths.p2d871200} fill="var(--stroke-0, black)" fillOpacity="0.1" id="Arrow 1" />
              </svg>
            </div>
          </div>
        </div>
      </div>
      <div className="absolute flex h-[148px] items-center justify-center left-[29px] top-[401px] w-0" style={{ "--transform-inner-width": "148", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg]">
          <div className="h-0 relative w-[148px]">
            <div className="absolute bottom-[-7.36px] left-0 right-[-0.68%] top-[-7.36px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 149 15">
                <path d={svgPaths.p1b70d580} fill="var(--stroke-0, black)" fillOpacity="0.1" id="Arrow 2" />
              </svg>
            </div>
          </div>
        </div>
      ...
      <Frame1 />
      <Frame2 />
      <div className="absolute flex h-[201px] items-center justify-center left-[29px] top-[570px] w-0" style={{ "--transform-inner-width": "201", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg]">
          <div className="h-0 relative w-[201px]">
            <div className="absolute bottom-[-7.36px] left-0 right-[-0.5%] top-[-7.36px]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 202 15">
                <path d={svgPaths.p378189c0} fill="var(--stroke-0, black)" fillOpacity="0.1" id="Arrow 3" />
              </svg>
            </div>
          </div>
        </div>
...
function Grabber1() {
  return (
    <div className="box-border content-stretch flex flex-col h-[16px] items-start pb-0 pt-[5px] px-0 relative shrink-0" data-name="Grabber">
      <Grabber />
    </div>
  );
}
...
function Title() {
  return (
    <div className="absolute h-[22px] left-1/2 top-[13px] translate-x-[-50%] w-[36px]" data-name="Title">
      <p className="absolute font-['SF_Pro:Semibold',sans-serif] font-[590] leading-[22px] left-[-13px] right-[-14px] text-[#333333] text-[17px] text-center text-nowrap top-0 tracking-[-0.43px] whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Caption
      </p>
    </div>
  );
...
function Toolbar() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-center left-0 pb-[10px] pt-0 px-0 top-[-1px] w-[390px]" data-name="Toolbar">
      <Grabber1 />
      <TitleAndControls />
    </div>
  );
...
function PopUpCation() {
  return (
    <div className="absolute h-[505px] left-0 top-[339px] w-[390px]" data-name="Pop up Cation">
      <ChatBubblePopUp />
      <Toolbar />
    </div>
  );
...
function Cc() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="cc 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_8103_20311)" id="cc 1">
          <path d={svgPaths.p2c2a3b00} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.pbc7f080} fill="var(--fill-0, #3E5FFF)" id="Vector_2" />
          <path d={svgPaths.p2dbab500} fill="var(--fill-0, white)" id="Vector_3" />
        </g>
        <defs>
          <clipPath id="clip0_8103_20311">
...
function Speed() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[10px] items-center justify-center p-[13px] relative rounded-[1000px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.2)] shrink-0 size-[60px]" data-name="Speed">
      <Cc />
    </div>
  );
}
...
function Actions() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-center left-[16px] top-[757px] w-[358px]" data-name="Actions">
      <ButtonGroups />
      <Mention />
    </div>
  );
...
function Video() {
  return (
    <div className="h-[844px] mb-[-844px] relative shrink-0 w-full" data-name="Video">
      ...
      <Top />
      <PopUpCation />
      <div className="absolute bg-gradient-to-b from-[14.672%] from-[rgba(243,244,246,0)] h-[127px] left-0 rounded-tl-[24px] rounded-tr-[24px] to-[#eceef1] to-[42.323%] top-[718px] w-[390px]" />
      <Actions />
      <NavigationBottom />
    </div>
  );
