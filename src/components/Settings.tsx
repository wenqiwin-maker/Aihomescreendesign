...
export function Settings({ onBack }: SettingsProps) {
  return (
    <div className="relative w-[390px] h-[844px] mx-auto bg-[#f5f6fa] overflow-hidden flex flex-col">
      ...
      <div
        className="absolute bottom-5 left-1/2 -translate-x-1/2 w-[350px] z-30"
        style={{
          borderRadius: '42px',
          background: 'rgba(247, 247, 247, 0.85)',
          backdropFilter: 'blur(20px)',
      ...
      {/* Home Indicator */}
      <div className="absolute bottom-2 left-1/2 -translate-x-1/2 w-[134px] h-[5px] bg-black rounded-full z-30" />
