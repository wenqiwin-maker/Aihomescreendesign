...
export function PostSimMicroReview({ onClose, onBack, onStartPractice, onWatchVideo }: PostSimMicroReviewProps) {
  const [expandedStructure, setExpandedStructure] = useState<string | null>('bluf');
  const [selectedStructure, setSelectedStructure] = useState<string>('bluf');
  ...
  const structures = [
    {
      ...
      content: [
        ...
        { label: 'Why', text: 'In the last two quarters, I led {Project X}, delivering key features ahead of schedule.' },
        { label: 'Next steps', text: 'Please confirm the review window by this Friday and let me know if you need additional documentation.' }
      ]
    },
    {
      id: 'star',
      ...
      selected: false,
      content: [
        { label: 'Situation', text: 'Our team was behind on Q2 deliverables with a critical deadline approaching.' },
        { label: 'Task', text: 'I needed to coordinate with cross-functional teams to get back on track.' },
        { label: 'Action', text: 'I organized daily standups, redistributed workload, and implemented better tracking.' },
        { label: 'Result', text: 'We delivered on time with 98% quality score and improved team velocity by 30%.' }
      ]
    },
    {
      id: 'problem',
      ...
      selected: false,
      content: [
        { label: 'Problem', text: 'Current deployment process takes 3 hours and blocks the team from shipping updates quickly.' },
        { label: 'Impact', text: 'This delays customer-facing features and reduces our competitive advantage.' },
        { label: 'Solution', text: 'Implement automated CI/CD pipeline to reduce deployment time to under 20 minutes.' },
        { label: 'Benefits', text: 'Team can ship 5x more frequently, faster iteration cycles, and improved developer experience.' }
      ]
    }
  ];
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#F5F6FA]">
      ...
      >
        {/* Status Bar */}
        <div className="flex justify-center items-center px-4 pt-[21px] pb-[19px] h-[62px]" style={{ gap: '154px' }}>
          {/* Time */}
        ...
        <div className="flex items-start px-5 gap-1 h-[3px] bg-white">
          ...
          <div className="w-[114px] h-[3px] rounded-sm" style={{ background: 'linear-gradient(90deg, #3E5FFF 41.06%, #00AEFF 100%)' }} />
          {/* Step 2 - Already filled */}
          <div className="w-[114px] h-[3px] rounded-sm" style={{ background: 'linear-gradient(90deg, #00AEFF 62.5%, #FF2AB4 100%)' }} />
          ...
          <div className="w-[114px] h-[3px] bg-[#E9EBF3] rounded-sm overflow-hidden">
            <motion.div
              ...
              style={{ background: 'linear-gradient(90deg, #FF2AB4 0%, #FFB800 100%)' }}
            />
          </div>
        </div>
          ...
          <div className="flex items-start gap-2 flex-wrap">
            ...
            >
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M6 4.32C5.07216 4.32 4.32 5.07216 4.32 6C4.32 6.92784 5.07216 7.68 6 7.68C6.92784 7.68 7.68 6.92784 7.68 6C7.68 5.07216 6.92784 4.32 6 4.32ZM0 6C0 2.68629 2.68629 0 6 0C9.31371 0 12 2.68629 12 6C12 9.31371 9.31371 12 6 12C2.68629 12 0 9.31371 0 6Z" fill="black"/>
              </svg>
              <span
                style={{ 
                  fontFamily: 'SF Pro', 
            ...
            >
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.75736 10.2426C0.632141 9.11742 6.21849e-07 7.59129 6.91407e-07 5.99998L5.9865 5.99998C4.33585 5.99271 3 4.65236 3 3.00001C3 1.34315 4.34315 -2.62268e-07 6 -2.62268e-07C7.65686 -2.62268e-07 9 1.34315 9 3.00001C9 4.65236 7.66415 5.99271 6.0135 5.99998L12 5.99999C12 7.59129 11.3679 9.11742 10.2426 10.2426C9.11742 11.3679 7.5913 12 6 12C4.4087 12 2.88258 11.3679 1.75736 10.2426Z" fill="#050505"/>
              </svg>
              <span
                style={{ 
                  fontFamily: 'SF Pro', 
            ...
            >
              <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.61328 2.30469V3.00684H12.001V12H0V3.00684H2.50195V2.0752L4.50195 0H7.3916L9.61328 2.30469ZM4.28027 3.00684H7.83496V1.84473H4.28027V3.00684Z" fill="#050505"/>
              </svg>
              <span
                style={{ 
                  fontFamily: 'SF Pro', 
            ...
            {structures.map((structure) => (
              ...
              >
                <div className="p-4 flex flex-col gap-4">
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex items-center gap-2">
                      <div 
                        ...
                        style={{ background: structure.icon ? 'transparent' : structure.bgColor }}
                      >
                        {structure.icon ? (
                          <ImageWithFallback 
                            src={structure.icon} 
                  ...
                  {expandedStructure === structure.id && structure.content.length > 0 && (
                    <div 
                  ...
                  <div
                    onClick={(e) => {
                      e.stopPropagation();
                      setExpandedStructure(expandedStructure === structure.id ? null : structure.id);
                    }}
