...
import cooperativeIconImg from "../assets/cooperative-icon.png";
import cooperativeIconWhite from "../assets/cooperative-icon-white.png";
import neutralIconImg from "../assets/neutral-icon.png";
import neutralIconWhite from "../assets/neutral-icon-white.png";
import defensiveIconImg from "../assets/defensive-icon.png";
import defensiveIconWhite from "../assets/defensive-icon-white.png";
...
export function QuickSetup3({
  ...
  return (
    <div className="relative w-[390px] h-screen bg-white overflow-hidden mx-auto">
      {/* Status Bar */}
