import svgPaths from "../imports/svg-23k6icirjq";
    ...
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_8043_1376)" id="Icon">
          <path d="M8 4V8L10.6667 9.33333" id="Vector" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p39ee6532} id="Vector_2" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
        <defs>
...
export function BottomButton({ onClick }: { onClick: () => void }) {
  return (
    <div className="bg-white relative w-full" data-name="Bottom button">
      ...
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-start pb-[36px] pt-[12px] px-[16px] relative w-full">
